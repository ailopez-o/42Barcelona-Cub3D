...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/19 17:51:02 by framos-p          #+#    #+#             */
/*   Updated: 2023/11/19 17:58:33 by framos-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * get_closest_colision - finds the closest collision between a ray and WALL
 * objects
 * This function takes a pointer to the first `WALL` object in a 3D scene,
 * the
 ...
 * function calculates the distance between the collision point and the
 * starting
 * position of the ray. The function then returns the closest collision that
 * was found.
 ...
 * Return: The closest collision found between the ray and a `WALL` object's
 * polygon
 */
